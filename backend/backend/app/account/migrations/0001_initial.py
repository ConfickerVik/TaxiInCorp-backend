# Generated by Django 4.2.10 on 2024-04-19 09:13

import backend.app.account.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', backend.app.account.models.CustomManager()),
            ],
        ),
        migrations.CreateModel(
            name='UserRole',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('passenger', 'Passenger'), ('drive', 'Driver')], default='passenger', max_length=12)),
            ],
        ),
        migrations.CreateModel(
            name='Car',
        ...
        migrations.AddField(
            model_name='user',
            name='fk_role',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='account.userrole'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
